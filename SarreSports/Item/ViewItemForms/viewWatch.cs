//Project Name: SarreSports | File Name: viewWatch.cs
//Author Name: Samuel Steven David Herring
//Author Email: s.s.herring1042@canterbury.ac.uk
//Author URI: http://sherring.me
//UserID: sh1042
//Created On: 7/1/2019 | 16:00
//Last Updated On:  7/1/2019 | 16:14
using System;
...
{
    public partial class viewWatch : viewItem
    {
        private Watch product;
        public int valueReturn { get; set; }

        public viewWatch(int productID, Branch currentBranch, viewItemState state)
        {
            InitializeComponent();

            if (!base.updateViewItemState(state) || !(currentBranch.findProduct(productID) is Watch))
            {
            ...
            {
                product = (Watch)currentBranch.findProduct(productID);
        ...
        private void updateSpecificAttributes(dynamic product)
        {
            if (product is Watch)
            {
                uiWatchTypeTextBox.Text = product.WatchType.ToString() ?? "Not Found";
            }
        }
